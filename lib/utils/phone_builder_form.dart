...
class MyFormBuilderPhoneField extends StatefulWidget {
  ...
  @override
  MyFormBuilderPhoneFieldState createState() => MyFormBuilderPhoneFieldState();
}

class MyFormBuilderPhoneFieldState extends State<MyFormBuilderPhoneField> {
